...
export const experience = [
  {
    ...
    location: 'Dublin, Ireland',
    tagline:
      'Own end-to-end customer operations for a 200+ customer portfolio, resolving high-volume queries, safeguarding data integrity, and driving the reporting and process improvements that keep service running smoothly.',
    highlights: [
  ...
  },
  {
    ...
    location: 'Dublin, Ireland',
    tagline:
      'Delivered customer service and retail operations for a global B2C consumer beauty brand, supporting the end-to-end customer experience across retail locations.',
    highlights: [
  ...
  },
  {
    ...
    tagline:
      'Delivered data validation, analysis, and reporting for banking and insurance applications across 15+ releases, maintaining high data integrity.',
    highlights: [
