...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section bg-[#07090d] relative overflow-hidden">
      {/* Background decoration */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] opacity-10 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at center, rgba(236,72,153,0.6) 0%, transparent 70%)' }}
      />
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 max-w-xl mx-auto text-base leading-relaxed">
            Open to Customer Operations, Account Management, and Operations Analyst opportunities in Dublin, Ireland.
            <br />
          ...
          <div ref={cardsRef} className="flex flex-col gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500">Kiruthiga Giridharan · Customer Operations</p>
              </div>
              <a
                href="/resume.pdf"
                ...
                style={{ background: 'linear-gradient(135deg, #ec4899, #c084fc)', boxShadow: '0 4px 20px rgba(236,72,153,0.25)' }}
              >
                Download PDF
              </a>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <div className="relative inline-flex mb-6">
                ...
                <div
                  className="absolute -bottom-2 -right-2 w-7 h-7 rounded-full border-2 border-[#07090d] flex items-center justify-center"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { label: 'Experience', value: '4.5+ Years', color: '#ec4899' },
                  { label: 'Current Role', value: 'Customer Ops', color: '#c084fc' },
                  { label: 'Location', value: 'Dublin 🇮🇪', color: '#7c3aed' },
                  { label: 'Education', value: 'MSc · BEng', color: '#a855f7' },
                  { label: 'Key Tools', value: 'Excel · SAP · SQL', color: '#ec4899' },
        ...
        <div className="mt-20 pt-8 border-t border-white/[0.06] text-center">
          <p className="text-gray-600 text-sm">
            Built with{' '}
            <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(135deg, #ec4899, #c084fc)' }}>
              React + Tailwind CSS
            </span>
            {' '}· Portfolio of{' '}
          ...
          <p className="text-gray-700 text-xs mt-1">
            Customer Operations Professional · Dublin, Ireland · {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </section>
