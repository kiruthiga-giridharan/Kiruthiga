      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-400 max-w-xl mx-auto">
            Academic foundations in statistical modelling, risk analytics, and engineering — complementing 4.5+ years of practical customer operations and data expertise
          </p>
        </div>
