...
const TechStack = () => {
  ...
  return (
    <section id="techstack" className="section bg-[#040f1e]">
      <div className="max-w-7xl mx-auto px-4">
            ...
            <button
              ...
              style={{
                background: filter === cat
                  ? `${categoryColors[cat] || '#0ea5e9'}25`
                  : 'rgba(255,255,255,0.04)',
                border: `1px solid ${filter === cat ? (categoryColors[cat] || '#0ea5e9') + '50' : 'rgba(255,255,255,0.08)'}`,
                color: filter === cat ? (categoryColors[cat] || '#0ea5e9') : undefined,
              }}
            >
              {cat}
            </button>
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {[
              { label: 'Tools Listed', value: technologies.length, color: '#0ea5e9' },
              { label: 'Categories', value: categories.length, color: '#4f46e5' },
              { label: 'Top Skill Level', value: '92%', color: '#38bdf8' },
              { label: 'Years Applied', value: '4.5+', color: '#4f46e5' },
            ].map((stat, i) => (
              <div key={i}>
