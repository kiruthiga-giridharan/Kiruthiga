      ...
      {PARTICLES.map(p => (
        <div
          ...
          style={{
            ...
            height: `${p.size}px`,
            background: p.id % 3 === 0
              ? `rgba(123, 147, 176, ${p.opacity})`
              : `rgba(200, 169, 109, ${p.opacity})`,
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto w-full">
        ...
        >
          <span
            ...
            style={{
              backgroundImage: 'linear-gradient(135deg, #f9a8d4 0%, #e879f9 50%, #ec4899 100%)',
        ...
        >
          Customer Operations &nbsp;•&nbsp; Advanced Excel &nbsp;•&nbsp; SAP S/4HANA &nbsp;•&nbsp; KPI Reporting &nbsp;•&nbsp; SQL &nbsp;•&nbsp; Power BI
        </p>
        ...
        >
          4.5+ years delivering excellent service across B2C and enterprise environments, owning a 200+ customer portfolio with 100% on-time delivery and consistently high satisfaction.
        </p>
